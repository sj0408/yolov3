...
def test(cfg,
    ...
    for batch_i, (imgs, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)): # ommit tqdm printing
        ...
        output = non_max_suppression_ver_2(final_outputs, conf_thres=0.05, iou_thres=0.4)
